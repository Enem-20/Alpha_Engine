...
std::string Clerk::Misstep(uint16_t lineNumber, std::string fileName, std::string funcName, std::wstring formatter)
{
	if (trace)
	{
...
std::string Clerk::Knowledge(uint16_t lineNumber, std::string fileName, std::string funcName, std::wstring formatter)
{
	if (trace)
	{
...
std::string Clerk::Unravel(uint16_t lineNumber, std::string fileName, std::string funcName, std::wstring formatter)
{
	if (trace)
	{
...
std::string Clerk::Caveat(uint16_t lineNumber, std::string fileName, std::string funcName, std::wstring formatter)
{
	if (trace)
	{
...
std::string Clerk::Fall(uint16_t lineNumber, std::string fileName, std::string funcName, std::wstring formatter)
{
	if (trace)
	{
